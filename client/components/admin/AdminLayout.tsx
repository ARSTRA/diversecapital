      ...
      <aside className="w-64 bg-primary text-white hidden lg:flex flex-col fixed h-full z-20">
        <div className="p-6 border-b border-white/10">
          <Link to="/" className="flex items-center gap-3 font-bold text-xl">
            ...
            <span>ADMIN <span className="text-secondary">PANEL</span></span>
          </Link>
        </div>
      ...
      <main className="flex-grow lg:ml-64 transition-all">
        ...
        <header className="bg-white border-b border-slate-200 h-20 flex items-center justify-between px-8 sticky top-0 z-10">
          <div>
            ...
            <p className="text-xs text-muted-foreground">Manage your platform and investments</p>
          </div>
          
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-end mr-4">
              <span className="text-sm font-bold text-primary">Admin Administrator</span>
              <span className="text-[10px] bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider">Super Admin</span>
            </div>
