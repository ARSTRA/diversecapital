    ...
    <footer className="bg-primary text-white pt-20 pb-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              ...
              <li>
                <Link
                  to="/investments/financial-services"
                  className="hover:text-secondary transition-colors"
                >
                  Insurance & Loans
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              <li className="flex items-start gap-3">
                ...
                <span>
                  {settings?.contactAddress ||
                    "123 Financial District, London, EC2V 6BT, UK"}
                </span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>
                  {settings?.contactEmail || "support@diverse-capital.com"}
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 text-center text-xs text-white/40">
          <p className="mb-4">
            DISCLAIMER: Investment in financial markets involves risk.
            Cryptocurrency, commodities, and real estate are volatile assets.
            Past performance is not indicative of future results. Please read
            our full Risk Disclosure before investing.
          </p>
          <p>
            {settings?.footerContent ||
              `© ${new Date().getFullYear()} Diverse Capital Investment Group. All rights reserved.`}
          </p>
        </div>
      </div>
    </footer>
