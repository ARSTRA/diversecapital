        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Invest in Premier{" "}
              <span className="text-secondary">Real Estate</span> Portfolios
            </h1>
            <p className="text-xl text-white/70 leading-relaxed">
              Build your wealth through high-yield, professionally managed
              properties. From luxury residential to strategic commercial
              developments, access global real estate markets with fractional
              ownership.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl font-bold text-primary leading-tight">
                The Power of Fractional Real Estate Investing
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Traditionally, high-yield real estate was reserved for
                institutional investors or the ultra-wealthy. We've democratized
                access, allowing you to invest in premium assets with smaller
                capital outlays.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Regular rental income distributions paid directly to your wallet.",
                    icon: <DollarSign className="w-5 h-5" />,
                  },
                  {
                    title: "Capital Appreciation",
                    desc: "Benefit from long-term property value growth in prime markets.",
                    icon: <TrendingUp className="w-5 h-5" />,
                  },
                  {
                    title: "Low Entry Barrier",
                    desc: "Start with as little as $1,000 and build a diversified property portfolio.",
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                Explore our hand-picked selection of high-yield properties
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {properties.map((prop) => (
              <div
                key={prop.title}
                className="bg-white rounded-[40px] overflow-hidden border border-slate-200 group flex flex-col sm:flex-row"
              >
            ...
            <div className="flex flex-col lg:flex-row gap-16 relative z-10">
              <div className="lg:w-1/2 space-y-8">
                <h2 className="text-4xl font-bold text-white">
                  Transparent & Regulated Structures
                </h2>
                <p className="text-lg text-white/70 leading-relaxed">
                  Every property is held within a dedicated Special Purpose
                  Vehicle (SPV), ensuring your ownership is legally protected
                ...
                <Button
                  size="lg"
                  className="bg-secondary hover:bg-secondary/90 text-white px-10 h-14 text-lg"
                >
              ...
              <div className="lg:w-1/2 grid grid-cols-1 gap-6">
                {[
                  {
                    title: "Due Diligence",
                    desc: "Our team of experts reviews 100+ opportunities for every 1 that makes it onto the platform.",
                    icon: <Badge className="w-10 h-10 mb-4" />,
                  },
                  {
                    title: "Global Compliance",
                    desc: "We operate in full compliance with FCA and SEC real estate investment regulations.",
                    icon: <ShieldCheck className="w-10 h-10 mb-4" />,
                  },
                  {
                    title: "Investor Protection",
                    desc: "Capital is safeguarded through insurance and institutional-grade custody solutions.",
                    icon: <Users className="w-10 h-10 mb-4" />,
                  },
                ].map((box) => (
                  <div
                    key={box.title}
                    className="p-8 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 hover:bg-white/10 transition-colors"
                  >
