...
const getIcon = (category: string) => {
  switch (category) {
    ...
    case "Gold":
      return <Pickaxe className="w-8 h-8 text-secondary" />;
    case "Agriculture":
      return <Leaf className="w-8 h-8 text-secondary" />;
    case "Oil & Gas":
      return <Droplets className="w-8 h-8 text-secondary" />;
    default:
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-primary leading-[1.1]">
                Diversify Your <span className="text-secondary">Wealth</span>{" "}
                Across Six Industries
              </h1>
              <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
                One platform, infinite opportunities. Securely manage your
                portfolio in Crypto, Real Estate, Energy, and more with
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/admin">
                  <Button
                    size="lg"
                    variant="outline"
                    className="px-8 h-14 text-lg border-secondary text-secondary"
                  >
                    Admin Dashboard
                  </Button>
                </Link>
      ...
      <section className="py-12 bg-primary">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-center gap-12 opacity-50 grayscale invert">
            ...
            />
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/FCA_logo.svg/1280px-FCA_logo.svg.png"
              alt="FCA"
              className="h-6"
            />
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/SEC_Logo.svg/1200px-SEC_Logo.svg.png"
              alt="SEC"
              className="h-8"
            />
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="text-center p-8 rounded-3xl bg-slate-50 hover:bg-secondary/5 transition-colors group"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              We've curated high-potential opportunities across six critical
              sectors, allowing you to build a resilient and growth-oriented
              portfolio.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {productsLoading ? (
              [1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-64 bg-slate-100 animate-pulse rounded-[32px]"
                />
              ))
              ...
              <div className="col-span-full text-center py-20 bg-white rounded-[32px] border border-dashed border-slate-200">
                <p className="text-muted-foreground">
                  No featured investments available at the moment.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Your capital's safety is our primary objective. We employ
                multi-layer security protocols and comply with international
                ...
                {[
                  {
                    ...
                    desc: "95% of digital assets are stored in multi-signature cold wallets.",
                    icon: <ShieldCheck className="w-6 h-6" />,
                  },
                  {
                    title: "Audited Financials",
                    desc: "Regular third-party audits ensure transparency and solvency.",
                    icon: <CheckCircle2 className="w-6 h-6" />,
                  },
                  {
                    title: "KYC/AML Compliance",
                    desc: "Strict onboarding processes to maintain a clean investment ecosystem.",
          ...
          <div className="bg-primary rounded-[60px] p-12 lg:p-24 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-xl text-white/70 leading-relaxed">
                Join thousands of professional investors who trust Diverse
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/signup">
                  <Button
                    size="lg"
                    className="bg-secondary hover:bg-secondary/90 text-white px-10 h-14 text-lg w-full sm:w-auto"
                  >
                    Open Free Account
                  </Button>
                </Link>
                <Link to="/contact">
                  <Button
                    size="lg"
                    variant="outline"
                    className="text-white border-white/20 hover:bg-white/10 px-10 h-14 text-lg w-full sm:w-auto"
                  >
