    ...
    <AdminLayout>
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Button
            variant="outline"
            className="h-14 rounded-2xl gap-2 px-6 border-slate-200"
          >
                  ...
                  {isLoading
                    ? [1, 2, 3].map((i) => (
                        <tr key={i} className="animate-pulse">
                          <td
                            colSpan={7}
                            className="px-8 py-8 bg-slate-50/50"
                          />
                        </tr>
                      ))
                    : orders.map((order) => (
                        ...
                        >
                          ...
                          <td className="px-8 py-5">
                            ...
                            >
                              <div
                                className={cn(
                                  "w-1.5 h-1.5 rounded-full fill-current",
                                )}
                              />
                              {order.status}
                            </span>
                          ...
                          <td className="px-8 py-5 text-right">
                            <DropdownMenu>
                              ...
                              >
                                ...
                                <DropdownMenuItem
                                  className="text-xs font-bold py-2 text-red-600"
                                  onClick={() =>
                                    updateStatusMutation.mutate({
                                      id: order.id,
                                      status: "Cancelled",
