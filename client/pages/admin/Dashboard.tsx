...
const stats = [
  { label: "Total Revenue", value: "$428,500", icon: TrendingUp, change: "+12.5%", positive: true },
  { label: "Active Investors", value: "2,482", icon: Users, change: "+8.2%", positive: true },
  { label: "Pending Orders", value: "18", icon: ShoppingCart, change: "-3.1%", positive: false },
  { label: "Avg. ROI", value: "18.4%", icon: Activity, change: "+2.4%", positive: true },
];
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => {
            ...
            return (
              <Card key={stat.label} className="border-none shadow-sm rounded-[24px]">
        ...
        <Card className="border-none shadow-sm rounded-[32px] overflow-hidden">
          <CardHeader className="p-8 border-b border-slate-50 flex flex-row items-center justify-between">
            <CardTitle className="text-lg font-bold">Recent Investment Orders</CardTitle>
                    ...
                    <tr key={i} className="hover:bg-slate-50 transition-colors">
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-bold text-sm text-primary">Investor {i}</span>
                        </div>
                      </td>
                      <td className="px-8 py-5">
                        <span className="text-sm font-medium">Crypto Mining</span>
                      </td>
                      <td className="px-8 py-5">
                        <span className="text-sm font-bold text-primary">$5,000.00</span>
                      </td>
                      <td className="px-8 py-5">
                        <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-[10px] font-bold uppercase tracking-wider">Profits</span>
                      </td>
                      <td className="px-8 py-5">
